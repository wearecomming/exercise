...
train_data= DatasetFromCSV('E:\exercise\python\handwrite_number_recognize/train.csv', 28,28,transform)
test_data = DatasetFromCSV("E:\exercise\python\handwrite_number_recognize/test.csv",28,28,transform)
